...
| Version | 1.7 |
| Status | Final public maintenance release `v2.0.5`; V2.0.4, V2.0.3, V2.0.2, V2.0.1, and V2.0.0 preserved; V1 frozen on `main` |
| Date | 2026-07-28 |
...
## V2.0.5 Release-Date Metadata Maintenance

D2-032 authorizes V2.0.5 as a metadata-only maintenance release. It records
the V2.0.4 public GitHub publication timestamp as `2026-07-28T06:06:29Z` while retaining
2026-07-27 as the maintenance-work date. Current citation and release metadata
are synchronized to V2.0.5 dated 2026-07-28.

No scientific config, cohort, outcome, estimand, model, feature, interaction,
subgroup, tuning exercise, notebook, analysis script, scientific execution
script, aggregate result, table, figure, or conclusion is changed. V1 remains
separate on `main`. Final ARISE submission, final manuscript claims, merge to
`main`, and new scientific modeling remain unauthorized.
